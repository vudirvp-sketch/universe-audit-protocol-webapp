    ...
    try {
      ...
      if (parsed.grief_mapping) {
        ...
        result.grief_mapping = {
          ...
          justification_chain: Array.isArray(gm.justification_chain) ? gm.justification_chain.map(String) : [],
          justification: Array.isArray(gm.justification_chain) ? gm.justification_chain.map(String) : [],
        };
      }
